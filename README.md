...
Ближайшие пользовательские улучшения:

- плановые платежи и доходы: зарплата, аренда, ЖКХ, подписки, обучение;
- календарь ближайших обязательств и предупреждения по будущему cashflow;
- автосоздание операций из наступивших шаблонов;
- локальное сохранение desktop-данных для Tauri local mode через IndexedDB snapshot;
- улучшение дизайна ключевых сценариев: быстрее считать, проще добавлять, меньше таблиц на мобильном экране.
