...
const ru: Messages = {
  ...
  // --- Замок на книге (учётная запись) ---
  "vault.checking": "Проверяем замок…",
  "vault.setup.title": "Защитите книгу паролем",
  "vault.setup.lead":
    "Книга будет храниться на устройстве в зашифрованном виде. Пароль нужен, чтобы её открыть — и он же понадобится, когда книга начнёт синхронизироваться между устройствами.",
  ...
  "vault.setup.working": "Шифруем книгу…",
  "vault.code.title": "Запишите код восстановления",
  "vault.code.lead":
    "Двенадцать слов ниже — единственный путь к книге, если пароль забудется. Перепишите их на бумагу и уберите туда, где не потеряются.",
  "vault.code.warning":
    "Второй раз этот код не покажут. Потеряете и пароль, и код — книга пропадёт навсегда: ключа от неё нет ни у кого, включая нас.",
  ...
  "vault.unlock.title": "Книга заперта",
  "vault.unlock.lead": "Введите пароль, чтобы открыть её.",
  ...
  "vault.unlock.rememberHint":
    "Книга будет открываться сразу. Это удобно — и это значит, что её откроет любой, кто возьмёт это устройство в руки. На других устройствах пароль по-прежнему спросят.",
  ...
  "vault.settings.lock": "Запереть книгу",
  ...
  "sync.conflicts.lead":
    "Эти записи меняли и здесь, и на другом устройстве. Выберите, какую оставить — пока выбор не сделан, в книге лежит отмеченная как «сейчас».",
  ...
  "sync.conflicts.current": "сейчас в книге",
...
const en: Messages = {
  ...
  "vault.setup.title": "Protect the book with a password",
  "vault.setup.lead":
    "The book will be stored on this device encrypted. The password opens it — and it is the same password you will need once the book starts syncing between devices.",
  ...
  "vault.setup.working": "Encrypting the book…",
  "vault.code.title": "Write down the recovery code",
  "vault.code.lead":
    "These twelve words are the only way back into the book if the password is forgotten. Copy them onto paper and keep it somewhere safe.",
  "vault.code.warning":
    "This code will not be shown again. Lose both the password and the code and the book is gone for good: nobody holds a key to it, us included.",
  ...
  "vault.unlock.title": "The book is locked",
  ...
  "vault.unlock.rememberHint":
    "The book will open straight away. Convenient — and it means anyone who picks up this device opens it too. Other devices will still ask.",
  ...
  "vault.wipe.body":
    "The book is locked with a key nobody holds any more. Nothing can open it — not us, not you. All that is left is to erase everything and start from scratch: accounts, operations and plans go for good. If you have a backup file, close this window first — you can restore it once you have set a new password.",
  "vault.wipe.confirm": "Erase everything permanently",
  "vault.settings.title": "Book lock",
  "vault.settings.desc": "The password this book opens with.",
  ...
  "vault.settings.lock": "Lock the book",
  ...
  "sync.conflicts.lead":
    "These records were changed here and on another device. Choose which one to keep — until you do, the one marked \u00abnow\u00bb is what the book holds.",
  ...
  "sync.conflicts.current": "in the book now",
