...
const ru: Messages = {
  ...
  "set.accent.hint": "Цвет кнопок, ссылок и графиков. Сохраняется на этом устройстве.",
  "set.accent.emerald": "Изумрудный",
  "set.accent.blue": "Синий",
  "set.accent.violet": "Фиолетовый",
...
const en: Messages = {
  ...
  "set.accent.hint": "Colour of buttons, links and charts. Saved on this device.",
