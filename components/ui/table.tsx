...
>(({ className, ...props }, ref) => (
  <tbody
    ref={ref}
    // Zebra striping (quiet) + no border under the final row. Row hover in
    // TableRow wins over the stripe.
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("px-4 py-[var(--density-row-y)] align-middle", className)}
    {...props}
  />
));
