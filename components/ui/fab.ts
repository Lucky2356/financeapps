/**
 * The look both add buttons share — the round one on the phone bar and the
 * floating one on the desktop. It is the only solid accent fill in the system,
 * and the ring is what keeps it legible: a plain circle dissolved into whatever
 * table or chart it happened to land on, while a ring in the surrounding colour
