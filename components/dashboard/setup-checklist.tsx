...
//
// Резервной копии здесь нет. Полоса «копии нет» над главной тоже убрана — по
// просьбе владельца: предупреждение без крестика, висящее над каждым запуском,
// мешало больше, чем помогало. Копия живёт в настройках, там же — копии по
// расписанию.
