...
**Отката.** Схема хранилища едет вперёд (сейчас 16), миграции односторонние. Если
предварительная сборка переведёт вашу книгу на следующую схему, прошлая версия
свою же книгу не прочитает. Поэтому: **перед установкой предварительной сборки
выгружайте резервную копию** — Настройки → Резервная копия. Это единственный
способ вернуться, пока откат миграций не сделан.
